...
CREATE TEMPORARY FUNCTION concatInts AS 'org.gbif.occurrence.typespecimenchecklist.ConcatIntUDF';
...
CREATE TABLE type_specimen_taxa ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t'
  ...
  AS SELECT o.gbifid, o.datasetkey, s.nameComplete AS scientificName, o.v_taxonRank,
    ...
    s.gbifids, CONCAT('Derived from GBIF occurrences: ', concatInts(', ', s.gbifids)) AS remarks
